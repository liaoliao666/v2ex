    ...
    plugin(({ addUtilities }) => {
      addUtilities(
        withTailWindHint({
          ...
          'text-body-1': 'text-[23px] leading-[28px]',
          'text-body-2': 'text-[20px] leading-[24px]',
          'text-body-3': 'text-[19px] leading-[22px]',
          'text-body-4': 'text-[17px] leading-[20px]',
          'text-body-5': 'text-[15px] leading-[20px]',
          'text-body-6': 'text-[13px] leading-[16px]',
          'bg-body-1': 'bg-white dark:bg-black',
          'bg-body-1-invert': 'dark:bg-white bg-black',
          'bg-body-2': 'bg-[#f0f3f5] dark:bg-[#0f0f0f]',
