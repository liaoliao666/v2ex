...
export interface ParallaxScrollViewProps {
  ...
  onChangeHeaderVisibility?: () => JSX.Element
...
export default class ParallaxScrollView extends Component<ParallaxScrollViewProps> {
   ...
   */
  getScrollResponder() {
    return this._scrollview_ref._component.getScrollResponder()
  }
  getScrollableNode() {
  ...
  setNativeProps(props) {
    this._scrollview_ref.setNativeProps(props)
  }
